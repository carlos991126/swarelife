...
<a class="btn btn-success"  href="reporte/index2.php">Generar reportes</a>
			...
			<table class='table'>
				...
				<center><h2>Administradores</h2></center>

				<br>

				<tr>
					<th width="11%">Id</th><th width="17%">Nombre</th><th width="14%">Apellido</th><th width="12%">Correo</th><th width="16%">Documento</th><th width="19%">Correo</th><th width="11%">Celular</th>
				</tr>			
                   ...
                   echo "<td>$fila[4]</td>"; 
                    ...
                    echo "<td>$fila[7]</td>"; 
                        echo "<td>$fila[11]</td>"; 
                         ...
                         echo "<td><a data-toggle='modal' data-target='#editUsu' data-primernombre='" .$fila[1] ."' data-segundonombre='" .$fila[2] ."' data-primerapellido='" .$fila[3] ."' data-segundoapellido='" .$fila[4] ."'data-tipo='" .$fila[5] ."' data-documento='" .$fila[6] ."' data-correoelectronico='" .$fila[7] ."' data-direccion='" .$fila[9] ."'  data-telefono='" .$fila[10] ."'  data-celular='" .$fila[11] ."' data-idestado='" .$fila[12] ."' class='btn btn-warning'><span class='glyphicon glyphicon-pencil'></span>Editar</a> </td>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="../model/capturar2.php" method="post">
...
<input  class="btn btn-primary" type="submit" name="volver" value="volver" href="../registro usuarios/index.php"    >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="actualiza.php" method="POST">                       		
                       			...
                       			<input class="form-control" id="primernombre" name="primernombre" type="text" placeholder="primer nombre" ></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="nombre">segundo nombre:</label>
                       			<input class="form-control" id="segundonombre" name="segundonombre" type="text" placeholder="segundo nombre" ></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="nombre">primer apellido:</label>
                       			<input class="form-control" id="primerapellido" name="primerapellido" type="text" placeholder="primer apellido" ></input>
                       		</div>
                       		
                       		
                       		<div class="form-group">
                       			<label for="nombre">Segundo apellido:</label>
                       			<input class="form-control" id="segundoapellido" name="segundoapellido" type="text" placeholder="segundo apellido" ></input>
                       		</div>
                       		<div class="form-group">
                       			<label for="edad">Tipo de documento:</label>
                       			<select  class="form-control" name="tipodocumento" placeholder="tipodocumento" >
                       		...
                       		<div class="form-group">
                       			...
                       			<input class="form-control" id="correoelectronico" name="correoelectronico" type="text" placeholder="Correo" ></input>
                       		</div>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="telefono" name="telefono" type="number" placeholder="Telefono"  ></input>
                          </div>

                          <div class="form-group">
                            <label for="direccion">Celular:</label>
                            <input class="form-control" id="celular" name="celular" type="number" placeholder="Celular"  ></input>
                          </div>
                          ...
                          <div class="form-group">
                            <label for="direccion">LLene los siguientes campos si desea cambiar la contraseña:</label>
                            
                          </div>

                          <div class="form-group">
                            <label for="direccion">Nueva contraseña:</label>
                            <input class="form-control" id="contrasena" name="contrasena" type="text" placeholder="Contraseña"  ></input>
                          </div>


                          <div class="form-group">
                            <label for="direccion">Repita la contraseña:</label>
                            <input class="form-control" id="repcontrasena" name="repcontrasena" type="text" placeholder="contrasena"  ></input>
                          </div>
  ...
  <script>       
      ...
      var recipient0 = button.data('primernombre')
      var recipient1 = button.data('segundonombre')
      var recipient2 = button.data('primerapellido')
      var recipient3 = button.data('segundoapellido')
      var recipient4 = button.data('idtipodocumento')
      var recipient5 = button.data('documento')
      var recipient6 = button.data('correoelectronico')
      var recipient7 = button.data('contrasena')
      var recipient8 = button.data('direccion')
            var recipient9 = button.data('telefono')
      var recipient10 = button.data('celular')
      var recipient11 = button.data('idestado')
       // Extract info from data-* attributes
      // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
      // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
     
      var modal = $(this)    
      modal.find('.modal-body #primernombre').val(recipient0)
      modal.find('.modal-body #segundonombre').val(recipient1)

      modal.find('.modal-body #primerapellido').val(recipient2)
      modal.find('.modal-body #segundoapellido').val(recipient3)

      modal.find('.modal-body #idtipodocumento').val(recipient4)
      modal.find('.modal-body #documento').val(recipient5)  
      modal.find('.modal-body #correoelectronico').val(recipient6)
      modal.find('.modal-body #contrasena').val(recipient7)
            modal.find('.modal-body #direccion').val(recipient8)
      modal.find('.modal-body #telefono').val(recipient9)
      modal.find('.modal-body #celular').val(recipient10)

      modal.find('.modal-body #estado').val(recipient11)  
    });
