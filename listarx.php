            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="../model/capturar.php" method="post">
...
<br><br>
 <div class="form-group"> 
 <label>Jornada estudiantil: </label> <br><select class="form-control" name="jornada" required>
...
<br><br>
<div class="form-group"> 
 <label>Curso:  </label>   <input class="form-control" type="text" name="curso" required />
</div>
